...
import type { SanityHeroPage, SanityLandingPage } from "~/lib/sanity";
import { ColorTheme } from "~/lib/theme";
import { fetchGids, notFound, validateLocale } from "~/lib/utils";
import { LANDINGPAGE_QUERY } from "~/queries/sanity/landingPage";
...
export async function loader({ params, context }: LoaderFunctionArgs) {
  ...
  const page = await context.sanity.query<SanityLandingPage>({
